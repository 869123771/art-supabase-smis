import"./rolldown-runtime-C0FnF6B9.js";import{Vt as e}from"./user-DmyIQTTj.js";import{t}from"./escape-CbUdcI6d.js";function n(n,r,i){let a=window.open(``,`_blank`,`width=980,height=760`);if(!a){e.warning(`浏览器阻止了打印窗口，请允许本站打开弹窗后重试`);return}a.opener=null;let o=n.items.map((e,n)=>`<tr><td>${n+1}</td><td>${t(e.materialName)}</td><td>${t(e.specificationModel||`—`)}</td><td>${t(String(e.issueQuantity))}</td><td>${t(i(e.unit))}</td><td>${t(e.remark||``)}</td></tr>`).join(``);a.document.write(`<!doctype html>
<html lang="zh-CN">
<head>
  <meta charset="utf-8">
