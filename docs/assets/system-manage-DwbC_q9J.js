import{q as e,z as t}from"./user-zsn2zgdj.js";import"./style-CCjDa5DA.js";import"./supabase-BE_2VzjO.js";import{t as n}from"./tree-D_nZY1Id.js";var{supabase:r,keysToSnakeDeep:i,responseHandle:a}=t(),o=new n({idKey:`id`,parentKey:`parentId`,childrenKey:`children`});async function s(t={}){let n=e(t.tenantId),i=r.from(`mdm_organization`).select(`id,tenant_id,parent_id,organization_code,organization_name,organization_type,status,sort,is_system,
