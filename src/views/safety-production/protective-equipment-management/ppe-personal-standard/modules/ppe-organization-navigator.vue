<template>
  ...
  >
    ...
    <div class="ppe-org-nav__content">
      <ElInput
        v-model="keyword"
        clearable
      ...
      <div class="ppe-org-nav__section-label">
        <span>组织结构</span><small>{{ organizationCount }} 个有效节点</small>
      </div>

      <ElScrollbar class="ppe-org-nav__scrollbar">
        <ElTree
          ref="treeRef"
          :data="data"
          :props="treeProps"
      ...
      <footer class="ppe-org-nav__selection" aria-live="polite">
