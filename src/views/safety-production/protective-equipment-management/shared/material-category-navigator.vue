<template>
  <ArtSectionCard
    class="material-category-navigator"
    title="物料类别层级"
    subtitle="分类上下文与列表同步"
    :loading="loading"
    :error="error"
  ...
  >
    ...
    <div class="material-category-navigator__content">
      <ElInput
        v-model="keyword"
        clearable
      ...
      <button
        type="button"
        class="material-category-navigator__all"
      ...
      <div class="material-category-navigator__section-label">
        <span>分类结构</span>
        <small>{{ categoryCount }} 个节点</small>
      </div>

      <ElScrollbar class="material-category-navigator__scrollbar">
        <ElTree
          ref="treeRef"
          :data="data"
          :props="treeProps"
        ...
        >
          <template #default="{ data: node }">
            <div class="material-category-navigator__node">
              <span
                class="material-category-navigator__node-icon"
              ...
              <ArtSvgIcon
                ...
                class="material-category-navigator__check"
                icon="ri:check-line"
                aria-hidden="true"
              />
            </div>
