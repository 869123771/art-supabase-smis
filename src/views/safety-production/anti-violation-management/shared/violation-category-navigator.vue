<template>
  <ArtSectionCard
    class="violation-category-navigator"
    title="违章分类层级"
  ...
  >
    ...
    <div class="violation-category-navigator__content">
      <ElInput
        v-model="keyword"
        clearable
      ...
      <button
        type="button"
        class="violation-category-navigator__all"
      ...
      <div class="violation-category-navigator__section-label">
        <span>分类结构</span>
        <small>{{ categoryCount }} 个节点</small>
      </div>

      <ElScrollbar class="violation-category-navigator__scrollbar">
        <ElTree
          ref="treeRef"
          :data="data"
          :props="treeProps"
        ...
        >
          <template #default="{ data: node }">
            <div class="violation-category-navigator__node">
              <span
                class="violation-category-navigator__node-icon"
              ...
              <ArtSvgIcon
                ...
                class="violation-category-navigator__check"
                icon="ri:check-line"
                aria-hidden="true"
              />
            </div>
