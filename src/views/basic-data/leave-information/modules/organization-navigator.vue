<template>
  ...
  >
    ...
    <div class="leave-organization__content">
      <ElInput
        v-model="keyword"
        clearable
      ...
      <ElScrollbar class="leave-organization__scrollbar">
        ...
        >
          <template #default="{ data: node }">
            <div class="leave-organization__node">
              ...
              <ArtSvgIcon
                ...
                class="leave-organization__check"
                icon="ri:check-line"
                aria-hidden="true"
              />
            </div>
