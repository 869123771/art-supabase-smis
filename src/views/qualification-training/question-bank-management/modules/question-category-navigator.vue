<template>
  <ArtSectionCard
    class="question-category-navigator"
    title="题库分类"
  ...
  >
    ...
    <div class="question-category-navigator__content">
      ...
      <button
        type="button"
        class="question-category-navigator__all"
      ...
      <div class="question-category-navigator__section-label">
        <span>分类结构</span>
        <small>{{ categoryCount }} 个节点</small>
      </div>

      <ElScrollbar class="question-category-navigator__scrollbar">
        <ElTree
          ref="treeRef"
          :data="data"
          :props="treeProps"
        ...
        >
          <template #default="{ data: node }">
            <div class="question-category-navigator__node">
              <span
                class="question-category-navigator__node-icon"
              ...
              <ArtSvgIcon
                ...
                class="question-category-navigator__check"
                icon="ri:check-line"
                aria-hidden="true"
              />
            </div>
